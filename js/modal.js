...
function createModal(container) {
    ...
    var content = container.querySelector(".modal1-content");
    var dialog = container.querySelector(".modal1-dialog");
    var polygon = container.querySelector(".modal1-polygon");
    var svg = container.querySelector(".modal1-svg");
